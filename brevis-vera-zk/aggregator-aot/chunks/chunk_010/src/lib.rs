...
pub fn block_0x00209140(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.adi_no_count(2usize, 2usize, 1288u32, 2134352u32);
...
pub fn block_0x0020915c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2134368u32;
    emu.update_insn_clock();
    emu.lw_no_count(10usize, 10usize, 960u32, 2134372u32)?;
...
pub fn block_0x00209168(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2134380u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1196u32, 2134384u32);
    emu.add_memory_rw_events(2usize);
    emu.pc = 2134384u32;
    emu.check_chunk_boundary_fast();
    if emu.should_yield() {
...
pub fn block_0x002091a0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2134436u32;
    emu.update_insn_clock();
    emu.sw_no_count(12usize, 11usize, 960u32, 2134440u32)?;
...
pub fn block_0x002091ac(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2134452u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1592u32, 2134456u32);
    ...
    emu.pc = 2134488u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 1600u32, 2134492u32);
...
pub fn block_0x002091e8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2134556u32;
    emu.update_insn_clock();
    emu.adi_no_count(18usize, 8usize, 968u32, 2134560u32);
...
pub fn block_0x00209284(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.sw_no_count(9usize, 8usize, 968u32, 2134664u32)?;
    emu.sw_no_count(0usize, 8usize, 972u32, 2134668u32)?;
...
pub fn block_0x002092cc(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2134736u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1620u32, 2134740u32);
...
pub fn block_0x002093d8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2135004u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 4294965654u32, 2135008u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2135012u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1632u32, 2135016u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2135020u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1648u32, 2135024u32);
...
pub fn block_0x0020942c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2135092u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 644u32, 2135096u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2135100u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966012u32, 2135104u32);
    let a = 0u32.wrapping_add(2207744u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2135108u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 4294966756u32, 2135112u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2135116u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1712u32, 2135120u32);
...
pub fn block_0x00209580(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2135428u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1796u32, 2135432u32);
...
pub fn block_0x00209608(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2135580u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1752u32, 2135584u32);
...
pub fn block_0x002096c8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2135776u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1812u32, 2135780u32);
    ...
    emu.write_reg_no_count(1usize, return_addr);
    let target = base.wrapping_add(4294967012u32);
    emu.pc = target;
    emu.update_insn_clock();
    emu.check_chunk_boundary_fast();
    if emu.should_yield() {
