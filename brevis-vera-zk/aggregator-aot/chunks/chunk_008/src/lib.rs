...
pub const PC_MAX: u32 = 2130680u32;
pub fn lookup(pc: u32) -> Option<BlockFn> {
    ...
    if pc < 2127624u32 || pc > 2130680u32 {
        return None;
    }
...
pub fn block_0x0020776c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127728u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 896u32, 2127732u32);
...
pub fn block_0x002077d0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127836u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 896u32, 2127840u32);
...
pub fn block_0x00207874(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127996u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 956u32, 2128000u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2128004u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 940u32, 2128008u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2128012u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 976u32, 2128016u32);
...
pub fn block_0x0020796c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2128264u32, 45056u32, 2128268u32);
...
pub fn block_0x00207a74(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2128512u32, 45056u32, 2128516u32);
    emu.add_memory_rw_events(5usize);
    let base = emu.read_reg_b_tracked(1usize);
...
pub fn block_0x00207af8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2128632u32, 45056u32, 2128636u32);
    emu.add_memory_rw_events(2usize);
    let base = emu.read_reg_b_tracked(1usize);
...
pub fn block_0x00207ca0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2129076u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294965372u32, 2129080u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2129084u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 4294965624u32, 2129088u32);
...
pub fn block_0x00207d28(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2129212u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294965260u32, 2129216u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2129220u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 4294965324u32, 2129224u32);
...
pub fn block_0x00207e70(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2129532u32, 40960u32, 2129536u32);
    emu.add_memory_rw_events(5usize);
    let base = emu.read_reg_b_tracked(1usize);
...
pub fn block_0x00207f84(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2129824u32, 45056u32, 2129828u32);
    emu.add_memory_rw_events(9usize);
    let base = emu.read_reg_b_tracked(1usize);
...
pub fn block_0x00208014(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2129952u32, 40960u32, 2129956u32);
    emu.add_memory_rw_events(5usize);
    let base = emu.read_reg_b_tracked(1usize);
...
pub fn block_0x00208040(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2129996u32, 40960u32, 2130000u32);
    emu.add_memory_rw_events(5usize);
    let base = emu.read_reg_b_tracked(1usize);
...
pub fn block_0x002080b0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130100u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1212u32, 2130104u32);
...
pub fn block_0x002080d8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130140u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1212u32, 2130144u32);
...
pub fn block_0x002080fc(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130180u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 1092u32, 2130184u32);
...
pub fn block_0x002081c4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130380u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1184u32, 2130384u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130388u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1104u32, 2130392u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130396u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1196u32, 2130400u32);
...
pub fn block_0x002081f0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130436u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1152u32, 2130440u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130444u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1104u32, 2130448u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130452u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1168u32, 2130456u32);
...
pub fn block_0x00208228(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130492u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1120u32, 2130496u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130500u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1104u32, 2130504u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130508u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1136u32, 2130512u32);
...
pub fn block_0x00208260(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130532u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1068u32, 2130536u32);
    ...
    emu.pc = 2130568u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1076u32, 2130572u32);
...
pub fn block_0x002082d0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130644u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 992u32, 2130648u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130652u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 940u32, 2130656u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130660u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1016u32, 2130664u32);
...
pub fn block_0x002082f8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130684u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1032u32, 2130688u32);
