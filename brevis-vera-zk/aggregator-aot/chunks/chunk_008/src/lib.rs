...
pub fn block_0x0020776c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127728u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1208u32, 2127732u32);
...
pub fn block_0x002077d0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127836u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1208u32, 2127840u32);
...
pub fn block_0x00207874(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127996u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1268u32, 2128000u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2128004u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1252u32, 2128008u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2128012u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1288u32, 2128016u32);
...
pub fn block_0x00207ca0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2129076u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294965684u32, 2129080u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2129084u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 4294965936u32, 2129088u32);
...
pub fn block_0x00207d28(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2129212u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294965572u32, 2129216u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2129220u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 4294965636u32, 2129224u32);
...
pub fn block_0x002080b0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130100u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2130104u32);
...
pub fn block_0x002080d8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130140u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2130144u32);
...
pub fn block_0x002080fc(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130180u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 1404u32, 2130184u32);
...
pub fn block_0x002081c4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130380u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1496u32, 2130384u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130388u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1416u32, 2130392u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130396u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1508u32, 2130400u32);
...
pub fn block_0x002081f0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130436u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1464u32, 2130440u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130444u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1416u32, 2130448u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130452u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1480u32, 2130456u32);
...
pub fn block_0x00208228(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130492u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1432u32, 2130496u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130500u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1416u32, 2130504u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130508u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1448u32, 2130512u32);
...
pub fn block_0x00208260(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130532u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1380u32, 2130536u32);
    ...
    emu.pc = 2130568u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1388u32, 2130572u32);
...
pub fn block_0x002082d0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130644u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1304u32, 2130648u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2130652u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1252u32, 2130656u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2130660u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 1328u32, 2130664u32);
...
pub fn block_0x002082f8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130684u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1344u32, 2130688u32);
...
pub fn block_0x00208310(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2130708u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1524u32, 2130712u32);
