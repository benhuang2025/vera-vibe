...
pub fn block_0x00205c64(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2120828u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 160u32, 2120832u32);
...
pub fn block_0x00205c90(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2120860u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 800u32, 2120864u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2120868u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 784u32, 2120872u32);
...
pub fn block_0x00205cc4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2120904u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 823u32, 2120908u32);
...
pub fn block_0x00205ce0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2120940u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 900u32, 2120944u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2120948u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 4294966140u32, 2120952u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(16usize, a);
    emu.pc = 2120956u32;
    emu.update_insn_clock();
    emu.adi_no_count(16usize, 16usize, 884u32, 2120960u32);
...
pub fn block_0x00205d20(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2120996u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294965846u32, 2121000u32);
...
pub fn block_0x00205d3c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121024u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294965798u32, 2121028u32);
...
pub fn block_0x00205d58(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121052u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 834u32, 2121056u32);
...
pub fn block_0x00205d74(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121080u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 806u32, 2121084u32);
...
pub fn block_0x00205d90(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121108u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 828u32, 2121112u32);
...
pub fn block_0x00205dac(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121136u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966148u32, 2121140u32);
...
pub fn block_0x00205dc8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121164u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 858u32, 2121168u32);
...
pub fn block_0x00205df4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121224u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966032u32, 2121228u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2121232u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 300u32, 2121236u32);
...
pub fn block_0x00205e30(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121268u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966048u32, 2121272u32);
...
pub fn block_0x00205e70(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121332u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 467u32, 2121336u32);
...
pub fn block_0x00205e98(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121372u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 441u32, 2121376u32);
...
pub fn block_0x00205eb4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121408u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 496u32, 2121412u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(13usize, a);
    emu.pc = 2121416u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 506u32, 2121420u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(16usize, a);
    emu.pc = 2121424u32;
    emu.update_insn_clock();
    emu.adi_no_count(16usize, 16usize, 480u32, 2121428u32);
...
pub fn block_0x00205ef4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121468u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966060u32, 2121472u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2121476u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 376u32, 2121480u32);
...
pub fn block_0x00205f70(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121608u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 316u32, 2121612u32);
...
pub fn block_0x00205fbc(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121672u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 200u32, 2121676u32);
...
pub fn block_0x00205fd8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121700u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 200u32, 2121704u32);
...
pub fn block_0x00205ff4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121728u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966060u32, 2121732u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2121736u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 376u32, 2121740u32);
...
pub fn block_0x00206028(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121772u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 434u32, 2121776u32);
...
pub fn block_0x00206044(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121804u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 416u32, 2121808u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2121812u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 400u32, 2121816u32);
...
pub fn block_0x00206074(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121848u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 421u32, 2121852u32);
...
pub fn block_0x00206090(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2121876u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 392u32, 2121880u32);
...
pub fn block_0x002069a0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124196u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 1000u32, 2124200u32);
...
pub fn block_0x00206b14(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124572u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 2020u32, 2124576u32);
...
pub fn block_0x00206bdc(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124772u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 553u32, 2124776u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2124780u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 556u32, 2124784u32);
...
pub fn block_0x00206c04(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124812u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294965480u32, 2124816u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2124820u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 4294965484u32, 2124824u32);
