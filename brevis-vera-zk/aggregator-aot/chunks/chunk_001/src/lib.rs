...
pub fn block_0x00201404(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2102280u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2102284u32);
...
pub fn block_0x0020147c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2102400u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294965276u32, 2102404u32);
...
pub fn block_0x002014a0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2102436u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2102440u32);
...
pub fn block_0x00201514(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2102552u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2102556u32);
...
pub fn block_0x00201860(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2103396u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966928u32, 2103400u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2103404u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2103408u32);
...
pub fn block_0x002018c8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2103500u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966928u32, 2103504u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2103508u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2103512u32);
...
pub fn block_0x00201990(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2103700u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966928u32, 2103704u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2103708u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2103712u32);
...
pub fn block_0x00201c30(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2104372u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966928u32, 2104376u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2104380u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2104384u32);
...
pub fn block_0x00201c54(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2104408u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966928u32, 2104412u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2104416u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2104420u32);
...
pub fn block_0x00201c6c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2104432u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966928u32, 2104436u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2104440u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2104444u32);
...
pub fn block_0x00201dc8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2104780u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966988u32, 2104784u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2104788u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2104792u32);
...
pub fn block_0x00201e50(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2104916u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966988u32, 2104920u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2104924u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2104928u32);
...
pub fn block_0x00201fa4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105256u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966988u32, 2105260u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2105264u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2105268u32);
...
pub fn block_0x00201fbc(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105280u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966988u32, 2105284u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2105288u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2105292u32);
...
pub fn block_0x00201fd4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105304u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966988u32, 2105308u32);
    let a = 0u32.wrapping_add(2228224u32);
    emu.write_reg_no_count(12usize, a);
    emu.pc = 2105312u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294966936u32, 2105316u32);
