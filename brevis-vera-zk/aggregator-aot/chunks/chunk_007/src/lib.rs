...
pub fn block_0x00206c44(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124880u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 292u32, 2124884u32);
...
pub fn block_0x00206c60(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124912u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 292u32, 2124916u32);
...
pub fn block_0x00206c80(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124940u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 660u32, 2124944u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2124948u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 644u32, 2124952u32);
...
pub fn block_0x00206cb4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2124992u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 756u32, 2124996u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2125000u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 740u32, 2125004u32);
...
pub fn block_0x00206ce8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125044u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 699u32, 2125048u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2125052u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 372u32, 2125056u32);
...
pub fn block_0x00206d1c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125088u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 718u32, 2125092u32);
...
pub fn block_0x00206d38(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125116u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 809u32, 2125120u32);
...
pub fn block_0x00206d54(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125152u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 680u32, 2125156u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2125160u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 664u32, 2125164u32);
...
pub fn block_0x00206d88(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125196u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 774u32, 2125200u32);
...
pub fn block_0x00206da4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125224u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 800u32, 2125228u32);
...
pub fn block_0x00206dc0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125256u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 848u32, 2125260u32);
    let a = 0u32.wrapping_add(2232320u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2125264u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 832u32, 2125268u32);
...
pub fn block_0x00206e50(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125396u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2125400u32);
...
pub fn block_0x00207014(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125848u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1192u32, 2125852u32);
...
pub fn block_0x00207080(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2125956u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2125960u32);
...
pub fn block_0x0020709c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2126016u32;
    emu.update_insn_clock();
    emu.adi_no_count(19usize, 19usize, 1208u32, 2126020u32);
...
pub fn block_0x002071a4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2126248u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 1192u32, 2126252u32);
...
pub fn block_0x002071f8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2126336u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 1224u32, 2126340u32);
...
pub fn block_0x0020720c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2126356u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 1239u32, 2126360u32);
...
pub fn block_0x00207220(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2126372u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 1168u32, 2126376u32);
...
pub fn block_0x00207274(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.apc_no_count(1usize, 2126476u32, 94208u32, 2126480u32);
    emu.add_memory_rw_events(8usize);
    let base = emu.read_reg_b_tracked(1usize);
...
pub fn block_0x00207294(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2126492u32;
    emu.update_insn_clock();
    emu.adi_no_count(9usize, 9usize, 372u32, 2126496u32);
...
pub fn block_0x0020766c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127476u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2127480u32);
...
pub fn block_0x002076b4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2127544u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 1524u32, 2127548u32);
