...
pub fn block_0x00201ed0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.adi_no_count(11usize, 11usize, 4294966272u32, 2105064u32);
    ...
    emu.pc = 2105080u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 256u32, 2105084u32);
...
pub fn block_0x00201f40(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105180u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 4294966160u32, 2105184u32);
    ...
    emu.pc = 2105200u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 288u32, 2105204u32);
...
pub fn block_0x00202024(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105384u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 4294967008u32, 2105388u32);
...
pub fn block_0x00202040(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105440u32;
    emu.update_insn_clock();
    emu.adi_no_count(21usize, 21usize, 4294967068u32, 2105444u32);
...
pub fn block_0x002020ec(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105592u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 4294967108u32, 2105596u32);
...
pub fn block_0x0020215c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105700u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 320u32, 2105704u32);
...
pub fn block_0x002021f4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105848u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 304u32, 2105852u32);
...
pub fn block_0x00202260(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2105956u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 4294967008u32, 2105960u32);
...
pub fn block_0x0020227c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106016u32;
    emu.update_insn_clock();
    emu.adi_no_count(19usize, 19usize, 320u32, 2106020u32);
...
pub fn block_0x00202384(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106248u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 304u32, 2106252u32);
...
pub fn block_0x002023a4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106280u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 336u32, 2106284u32);
...
pub fn block_0x00202410(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106396u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 192u32, 2106400u32);
...
pub fn block_0x0020242c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106428u32;
    emu.update_insn_clock();
    emu.adi_no_count(13usize, 13usize, 192u32, 2106432u32);
...
pub fn block_0x0020244c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106456u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 372u32, 2106460u32);
    let a = 0u32.wrapping_add(2187264u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2106464u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 356u32, 2106468u32);
...
pub fn block_0x00202480(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106508u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 484u32, 2106512u32);
    let a = 0u32.wrapping_add(2187264u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2106516u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 468u32, 2106520u32);
...
pub fn block_0x002024b4(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106560u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 428u32, 2106564u32);
    let a = 0u32.wrapping_add(2187264u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2106568u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 412u32, 2106572u32);
...
pub fn block_0x002024e8(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106604u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 447u32, 2106608u32);
...
pub fn block_0x00202504(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106632u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 537u32, 2106636u32);
...
pub fn block_0x00202520(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106668u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 392u32, 2106672u32);
    let a = 0u32.wrapping_add(2187264u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2106676u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 376u32, 2106680u32);
...
pub fn block_0x00202554(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106712u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 502u32, 2106716u32);
...
pub fn block_0x00202570(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106740u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 528u32, 2106744u32);
    ...
    emu.apc_no_count(6usize, 2106756u32, 57344u32, 2106760u32);
    emu.add_memory_rw_events(7usize);
    let base = emu.read_reg_b_tracked(6usize);
...
pub fn block_0x0020258c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106772u32;
    emu.update_insn_clock();
    emu.adi_no_count(11usize, 11usize, 576u32, 2106776u32);
    let a = 0u32.wrapping_add(2187264u32);
    emu.write_reg_no_count(14usize, a);
    emu.pc = 2106780u32;
    emu.update_insn_clock();
    emu.adi_no_count(14usize, 14usize, 560u32, 2106784u32);
...
pub fn block_0x00202630(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2106932u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 4294967008u32, 2106936u32);
...
pub fn block_0x0020268c(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2107024u32;
    emu.update_insn_clock();
    emu.adi_no_count(12usize, 12usize, 584u32, 2107028u32);
...
pub fn block_0x002026c0(emu: &mut AotEmulatorCore) -> Result<crate::NextStep, String> {
    ...
    emu.pc = 2107076u32;
    emu.update_insn_clock();
    emu.adi_no_count(10usize, 10usize, 4294967008u32, 2107080u32);
